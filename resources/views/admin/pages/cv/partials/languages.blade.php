<input type="hidden" name="idioma_cv" id="idioma_cv" value="{{ !isset($cv) ? 'Português' : 'actual'}}">
        <div class="col-lg-4 col-md-6 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
            <div class="nav-wrapper position-relative end-0">
                <ul class="nav nav-pills nav-fill p-1" role="tablist" id="idioma-selector">
                     @if(isset($cv))
                        <li class="nav-item">
                            <a class="nav-link mb-0 px-0 py-1 active" data-idioma="actual" data-bs-toggle="tab" href="javascript:;" role="tab" aria-selected="false">
                    ...
                    @endif
                    <li class="nav-item">
                        <a class="nav-link mb-0 px-0 py-1 {{ isset($cv) ? ($cv->lang == 'Português' ? 'active' : '') : 'active' }}" data-idioma="Português" data-bs-toggle="tab" href="javascript:;" role="tab" aria-selected="true">
                            <i class="fas fa-language"></i>
