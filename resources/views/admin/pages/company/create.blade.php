@extends("layouts.app")
@section("title", "CVLineJobs | Registar Empresa")
...
<div class="container-fluid px-2 px-md-4">
      ...
      <div class="card card-body mx-2 mx-md-2 mt-n6">
        ...
        <form action="{{ route("adminer.management.company.store") }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method("POST")
