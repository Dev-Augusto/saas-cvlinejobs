...
Route::middleware(['auth'])->controller(AdminController::class)->prefix('/admin')->group(function (){
    ...
    Route::get("/curriculos-vitae", [CVController::class, "index"])->middleware(['auth', 'check.license'])->name("admin.cv.home");
    Route::get("/curriculos-vitae/pesquisar", [CVController::class, "search"])->middleware(['auth', 'check.license'])->name("admin.cv.search");
    Route::get("/curriculos-vitae/visualizar/{id}", [CVController::class, "details"])->middleware(['auth', 'check.license'])->name("admin.cv.details");
    Route::get("/curriculos-vitae/novo-curriculo", [CVController::class, "create"])->middleware(['auth', 'check.license'])->name("admin.cv.create");
    Route::post("/curriculos-vitae/novo-curriculo/criar", [CVController::class, "store"])->middleware(['auth', 'check.license'])->name("admin.cv.store");
    Route::get("/curriculos-vitae/editar-curriculo/{id}", [CVController::class, "edite"])->middleware(['auth', 'check.license'])->name("admin.cv.edite");
    Route::put("/curriculos-vitae/editar-curriculo/editar/{id}", [CVController::class, "update"])->middleware(['auth', 'check.license'])->name("admin.cv.update");
    Route::get("/curriculos-vitae/editar-curriculo/editar/designer/{id}/{id_model}", [CVController::class, "editeDesign"])->middleware(['auth', 'check.license'])->name("admin.cv.update.designer");
    Route::get("/curriculos-vitae/visualizar/novo-curriculo/{id}", [CVController::class, "show"])->middleware(['auth', 'check.license'])->name("admin.cv.show");
    Route::delete("/curriculos-vitae/eliminar/{id}", [CVController::class, "destroy"])->middleware(['auth', 'check.license'])->name("admin.cv.delete");
